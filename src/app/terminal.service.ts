...
export class TerminalService {
  ...
  private destroySplashEntry: string = "<span class='destroy'>DESTROY</span> src/app/splash-screen.component"
  ...
  private pushInitialLogEntries(): void {
    ...
    this.logSubject.next("<span class='construct'>CONSTRUCT</span> src/app/tab-headers.component");
    this.logSubject.next("<span class='inject'>INJECT</span> src/app/tab.service.ts");
    this.logSubject.next("<span class='inject'>INJECT</span> src/app/route.service.ts");
    this.logSubject.next("<span class='construct'>CONSTRUCT</span> src/app/tab-body.component");
    this.logSubject.next("<span class='inject'>INJECT</span> src/app/tab.service.ts");
    this.logSubject.next("<span class='construct'>CONSTRUCT</span> src/app/tab-linecount.component");
    this.logSubject.next("<span class='inject'>INJECT</span> src/app/tab.service.ts");
    this.logSubject.next("<span class='construct'>CONSTRUCT</span> src/app/tab-preview.component");
    return;
  }
  ...
  private pushClosingLogEntries(): void {
    ...
    this.logSubject.next("<span class='destroy'>DESTROY</span> src/app/tab-preview.component");
    this.logSubject.next("<span class='destroy'>DESTROY</span> src/app/tab-linecount.component");
    this.logSubject.next("<span class='destroy'>DESTROY</span> src/app/tab-body.component");
    this.logSubject.next("<span class='destroy'>DESTROY</span> src/app/tab-headers.component");
    return;
  }
  ...
  public pushLogEntry(clickedPage: Page, construct: boolean,  toggled: boolean, tabCount: number): void {
    ...
    if(clickedPage.name == "contact") {
      if(clickedPage.previewToggle == "0") {
        ...
        else componentName = "contact-linkedin";
      }
      else {
        if(toggled) componentName = "contact-linkedin";
        else componentName = "contact-email";
      }
    }
    if(construct) {
      ...
      this.logSubject.next("<span class='construct'>CONSTRUCT</span> src/app/splash-screen.component"); 
      if(componentName != "") {
        let entry: string = "<span class='construct'>CONSTRUCT</span> src/app/" + componentName + ".component";
        this.logSubject.next(entry);
      }
      if(clickedPage.name == "localWeather.app") {
        let entry: string = "<span class='inject'>INJECT</span> src/app/weather.service.ts";
        this.logSubject.next(entry);
      }
