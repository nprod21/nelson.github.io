...
export class ChartService {
  ...
  getChartElements(property: string): ChartElement[] {
  ...
  incrementChartElement(value: string, chartElements: ChartElement[]): boolean {
  ...
  getChartElementsWithRotateValues(chartElements: ChartElement[]): ChartElement[] {
  ...
  getRotateValue(index: number, chartElements: ChartElement[]): string {
  ...
  getFreePercentage(index: number, chartElements: ChartElement[]): number {
  ...
  setFilteredTickets(property: string, value: string, anyStatus: boolean, activeStatus?: boolean): void {
