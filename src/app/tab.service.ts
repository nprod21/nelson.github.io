...
import { TabScrollSetting } from './tab-scroll-setting';
...
export class TabService {
  ...
  private weatherFetchedSubject: BehaviorSubject<boolean> = new BehaviorSubject<boolean>(false);
  ...
  public weatherFetchedObservable: Observable<boolean> = this.weatherFetchedSubject.asObservable();
...
/* PUBLIC BEHAVIOUR SUBJECT / OBSERVABLE SETTERS */
  ...
  public updateWeatherFetchedSubject(): void {
    /* sends true weatherFetched value via behaviour subject/observable */ 
    this.weatherFetchedSubject.next(true);
    return;
  }
